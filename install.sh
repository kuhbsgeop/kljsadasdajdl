...
apply_existing_env_overrides() {
  ...
  ensure_env_var PUBLIC_LINK_REFRESH_INTERVAL "60"
...
5) Default protocol
  ...
  Reality minimum client version: ${REALITY_MIN_CLIENT_VERSION:-1.8.2} (Mihomo compatible)
